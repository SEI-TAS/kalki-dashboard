...
@REM Configuration:
@REM DASHBOARD_config.txt found in the DASHBOARD_HOME.
...
set "CFG_FILE=%APP_HOME%\DASHBOARD_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running dashboard.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !DASHBOARD_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
